...
const CLOUDINARY_CLOUD_NAME = import.meta.env.VITE_CLOUDINARY_CLOUD_NAME || 'careerak';
...
export const prepareImageUpload = async (file, options = {}) => {
  ...
  formData.append('upload_preset', import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET || 'careerak_preset');
