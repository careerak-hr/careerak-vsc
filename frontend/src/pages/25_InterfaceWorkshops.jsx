...
const InterfaceWorkshops = () => {
    ...
    return (
        <div className="interface-workshops-container">
            <div className="interface-workshops-content">
                <div className="under-development-card">
                    ...
                    <p className="under-development-description">
                        {language === 'ar' ? 'هذه الصفحة قيد التطوير حالياً. سيتم إطلاقها قريباً مع ميزات متقدمة للورش.' : 
                         language === 'fr' ? 'Cette page est en cours de développement. Elle sera bientôt disponible avec des fonctionnalités avancées pour les ateliers.' : 
                         'This page is currently under development. It will be launched soon with advanced features for workshops.'}
                    </p>
