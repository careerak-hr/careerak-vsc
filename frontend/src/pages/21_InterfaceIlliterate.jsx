...
const InterfaceIlliterate = () => {
    ...
    return (
        <div className="interface-illiterate-container">
            <div className="interface-illiterate-content">
                <div className="under-development-card">
                    ...
                    <p className="under-development-description">
                        {language === 'ar' ? 'هذه الصفحة قيد التطوير حالياً. سيتم إطلاقها قريباً مع واجهة صوتية متقدمة.' : 
                         language === 'fr' ? 'Cette page est en cours de développement. Elle sera bientôt disponible avec une interface vocale avancée.' : 
                         'This page is currently under development. It will be launched soon with advanced voice interface.'}
                    </p>
