...
export default function PolicyPage({ isModal = false, onClose, onAgree }) {
  ...
  const policyContent = (
    <div className="policy-content-container">
      ...
      <section>
        <h3>2. نطاق تطبيق سياسة الخصوصية</h3>
      ...
      <section>
        <h3>3. المعلومات التي نقوم بجمعها</h3>
        <div className="space-y-4">
          <div>
            <h4>أ. المعلومات التي يقدّمها المستخدم</h4>
      ...
      <section>
        <h3>4. أهداف جمع واستخدام البيانات</h3>
      ...
      <section>
        <h3>6. نقل البيانات عبر الحدود</h3>
      ...
      <section className="policy-contact-section">
        <h3>13. التواصل معنا</h3>
        <p>لأي استفسارات أو طلبات تتعلق بالخصوصية:</p>
        <p className="font-black mt-2">البريد الإلكتروني: <span className="policy-contact-email">careerak.hr@gmail.com</span></p>
  ...
  return (
    <div className={`policy-page-container ${isVisible ? 'opacity-100' : 'opacity-0'}`} dir="rtl">
