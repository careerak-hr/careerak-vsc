...
const ForgotPasswordPage = React.lazy(() => import('../pages/31_ForgotPasswordPage'));
const ResetPasswordPage = React.lazy(() => import('../pages/32_ResetPasswordPage'));
const OAuthCallback = React.lazy(() => import('../pages/33_OAuthCallback'));
...
const JobDetailPage = React.lazy(() => import('../pages/34_JobDetailPage'));
const CompanyProfilePage = React.lazy(() => import('../pages/35_CompanyProfilePage'));
const PostJobPage = React.lazy(() => import('../pages/10_PostJobPage'));
const CoursesPage = React.lazy(() => import('../pages/11_CoursesPage'));
const CourseDetailsPage = React.lazy(() => import('../pages/36_CourseDetailsPage'));
const CoursePlayerPage = React.lazy(() => import('../pages/37_CoursePlayerPage'));
const WishlistPage = React.lazy(() => import('../pages/38_WishlistPage'));
const BookmarkedJobsPage = React.lazy(() => import('../pages/39_BookmarkedJobsPage'));
const PostCoursePage = React.lazy(() => import('../pages/12_PostCoursePage'));
const PolicyPage = React.lazy(() => import('../pages/13_PolicyPage'));
const CertificateVerificationPage = React.lazy(() => import('../pages/44_CertificateVerificationPage'));
const VerificationPage = React.lazy(() => import('../pages/46_VerificationPage'));
const CertificatePublicVerifyPage = React.lazy(() => import('../pages/45_CertificatePublicVerifyPage'));
...
const NotificationsPage = React.lazy(() => import('../pages/40_NotificationsPage'));
const ConnectedAccountsPage = React.lazy(() => import('../pages/41_ConnectedAccountsPage'));
const AchievementsPage = React.lazy(() => import('../pages/42_AchievementsPage'));
const CertificatesGalleryPage = React.lazy(() => import('../pages/43_CertificatesGalleryPage'));
const MyReferralsPage = React.lazy(() => import('../pages/55_MyReferralsPage'));
const ReferralStatsPage = React.lazy(() => import('../pages/56_ReferralStatsPage'));
const RewardsStorePage = React.lazy(() => import('../pages/57_RewardsStorePage'));
const CompanyReferralDashboard = React.lazy(() => import('../pages/58_CompanyReferralDashboard'));
const LeaderboardPage = React.lazy(() => import('./Leaderboard/LeaderboardPage'));
const MyAppointmentsPage = React.lazy(() => import('../pages/50_MyAppointmentsPage'));
const GoogleCalendarCallback = React.lazy(() => import('../pages/51_GoogleCalendarCallback'));
...
const NotFoundPage = React.lazy(() => import('../pages/48_NotFoundPage'));
const ServerErrorPage = React.lazy(() => import('../pages/49_ServerErrorPage'));
