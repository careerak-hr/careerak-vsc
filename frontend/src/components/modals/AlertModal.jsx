...
const AlertModal = ({ isOpen, onClose, message, language, t }) => {
  ...
  return (
    <>
      ...
      >
        <div ref={modalRef} className="bg-[#E3DAD1] dark:bg-[#2d2d2d] p-8 rounded-[2.5rem] shadow-2xl text-center max-w-sm border-4 border-[#304B60] dark:border-[#D48161] animate-in fade-in zoom-in duration-300 transition-all">
          <p 
            id="alert-message"
