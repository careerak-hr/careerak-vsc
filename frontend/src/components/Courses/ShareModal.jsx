...
const ShareModal = ({ isOpen, onClose, courseId, courseTitle }) => {
  ...
  const generateShareUrl = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/courses/${courseId}/share`, {
        method: 'POST',
        headers: {
    ...
    <div className="share-modal-backdrop" onClick={handleBackdropClick}>
      <div className="share-modal">
        <div className="share-modal-header">
          <h2>{t.title}</h2>
          <button className="share-modal-close" onClick={onClose} aria-label={t.close}>
            ...
            <>
              ...
              <div className="share-social-section">
                ...
                <div className="share-social-buttons">
                  <button
                    className="share-social-button facebook"
                  ...
                  <button
                    className="share-social-button twitter"
                  ...
                  <button
                    className="share-social-button linkedin"
                  ...
                  <button
                    className="share-social-button whatsapp"
                  ...
                  <button
                    className="share-social-button telegram"
                  ...
                  <button
                    className="share-social-button email"
