...
const seoMetadata = {
  ...
  language: {
    ar: {
      ...
      description: 'اختر لغتك المفضلة للبدء في استخدام Careerak، منصة التوظيف والموارد البشرية الرائدة في العالم العربي. ندعم العربية والإنجليزية والفرنسية لتجربة أفضل.',
  ...
  login: {
    ar: {
      title: 'تسجيل الدخول إلى Careerak | الوصول إلى حسابك بأمان',
      description: 'سجل دخولك إلى حسابك في Careerak للوصول إلى فرص العمل، الدورات التدريبية، وإدارة ملفك الشخصي. منصة التوظيف الرائدة في العالم العربي. ابدأ الآن.',
